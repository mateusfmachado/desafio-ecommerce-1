...
const data = [
    {
        foto: `${process.env.PUBLIC_URL}/media/image/relogio-similar-1.png`,
        titulo: "Relogio Orient Automático 3 Estrelas",
        preco: "R$ 739,00"
    },
    {
        foto: `${process.env.PUBLIC_URL}/media/image/relogio-similar-2.png`,
        titulo: "Relogio Orient FlyTech Titanium 469TI005",
        preco: "R$ 990,00"
    },
    {
        foto: `${process.env.PUBLIC_URL}/media/image/relogio-similar-3.png`,
        titulo: "Relogio Orient FlyTech Titanium MBTTC015",
        preco: "R$ 1399,00"
    },
    {
        foto: `${process.env.PUBLIC_URL}/media/image/relogio-similar-4.png`,
        ...
        return (
            <div className="Recomendacoes flex vertical">
                <div className="flex flex-center">
                    <h3 className="text-center">Algumas peças que você pode gostar...</h3>
                    <br />
                </div>
...

                    {
                        data.map((item, index) => (
                            <div className="Recomendacao flex-1 flex vertical cursor" key={index}>
                                <div className="flex flex-center">
                                    <img alt={item.titulo} src={item.foto} />
                                </div>
                                <div className="flex flex-center">
